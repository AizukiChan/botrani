module.exports = {
  ...
  async execute(client, message, args) {
    ...
    const db = client.db;
    if (!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send('❌ **You can not use this command | Permission: BAN_MEMBERS**')
    if (!message.guild.me.hasPermission("BAN_MEMBERS")) return message.channel.send('❌ **I do not have the correct permissions | Permission : BAN_MEMBERS**')

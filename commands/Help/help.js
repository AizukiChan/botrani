...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    var prefix = await db.get(`prefix_${message.guild.id}`) || client.config.discord.prefix;
    ...
    if (args[0]) {
      ...
      const embed = new MessageEmbed()
        ...
        .addField('Important Links', `**[Invite Me](${client.config.discord.invite.replace("{clientId}", client.user.id)}) | [Support Server](${client.config.discord.server_support}||https://dsc.gg/persian-caesar)**`)
      ...
      if (!args[0]) {
        let help = new MessageEmbed()
          ...
          .setFooter(`Message Guild ${message.guild.name} | Created By Ranii :)`, `https://cdn.discordapp.com/attachments/1223224422731616417/1224822468309549208/unha.png?ex=661ee3d0&is=660c6ed0&hm=3c9a8b6b4480c29eff7c7cfb22ccba0adeaaa03825bbe3d4b6608b4cb8318e31&`)
          .setColor("#2F3136")
          ...
          .addField('Music 🎶\n Masih Tahap Percobaan, Belum Dapat Digunakan')
          .addField('Social Media', commandsData(client.commands.filter(c => c.category === 'Link')))
          .addField('Nsfw 🔞', commandsData(client.commands.filter(c => c.category === 'Nsfw 🔞')))
          .addField('Owner 👑\n Khadafia Rani')
          .setThumbnail(client.user.displayAvatarURL({ dynamic: true }))
          .setTimestamp()
          .addField('Important Links', `**[Invite Me](${client.config.discord.invite.replace("{clientId}", client.user.id)}) | [Support Server](${client.config.discord.server_support || "https://discord.gg/uY6zSGkwu6"})**`)
        ...
        let funEmbed = new MessageEmbed()
          ...
          .setThumbnail(message.client.user.displayAvatarURL({ format: "png" }))
          .setTitle(`Tekan Jika Ingin Join Discord :)`)
          .setDescription(`Follow Social Media Rani, Ini Adalah Command Social Media Rani`)
          .setURL('https://discord.gg/uY6zSGkwu6')
          .setFooter("Created By Ranii :)", `https://cdn.discordapp.com/attachments/1223224422731616417/1224822468309549208/unha.png?ex=661ee3d0&is=660c6ed0&hm=3c9a8b6b4480c29eff7c7cfb22ccba0adeaaa03825bbe3d4b6608b4cb8318e31&`)
          .setColor("#2F3136")
        commands.filter(c => c.category === 'Link').forEach((cmd) => {
          funEmbed.addField(`**Follow Instagram Rani**`)
        })
        ...
        .setDescription(`Follow Social Media Ranii\n <:Facebook:1222643370724294696> : Ranii Chan\n <:Tiktok:1222643431633981563> : KhadafiaRani`)
        .setURL('https://discord.gg/uY6zSGkwu6')
        .setFooter("Created By Ranii :)", `https://cdn.discordapp.com/attachments/1223224422731616417/1224822468309549208/unha.png?ex=661ee3d0&is=660c6ed0&hm=3c9a8b6b4480c29eff7c7cfb22ccba0adeaaa03825bbe3d4b6608b4cb8318e31&`)
        .setColor("#2F3136")
    ...
    function NeedHelpButtons() {
      ...
      let option10 = new MessageMenuOption()
        ...
        .setValue("vip")
        .setDescription("Follow Sosmed Ranii")
        .setDefault()
        .setEmoji("💎")
      let selection = new MessageMenu()
        ...
        .setMaxValues(1)
        .setMinValues(1)
        .setPlaceholder("🆘| Tekan ini untuk menampilkan bot command !!")
        .addOption(option1)
        .addOption(option2)
        .addOption(option3)
        .addOption(option4)
